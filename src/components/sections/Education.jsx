                ...
                <div className="flex-1 min-w-0">
                  <div className="overflow-hidden mb-0.5">
                    <motion.h3
                      ...
                      className="text-2xl md:text-3xl font-display font-bold neon-text"
                    >
                      {edu.degree}
                    </motion.h3>
                  </div>
                  ...
                  <p className="text-white/40 font-mono text-sm mt-1.5">{edu.university} · {edu.location}</p>
                </div>

                <div className="flex flex-col items-end gap-2 flex-shrink-0">
                  <span className="text-sm font-mono text-white/30">{edu.duration}</span>
                  {edu.gpa && (
                    <span className="text-sm font-mono text-[#00FF88] px-3 py-1 rounded-full bg-[#00FF8814] border border-[#00FF8833]">
                      GPA {edu.gpa}
                    </span>
                  )}
                </div>
